// This component wraps the imported Analytics Fuel Purchase design
// and positions it to show only the content area (metrics + charts)

import { useState, useEffect } from "react";

export function FuelPurchaseContent() {
  const AnalyticsFuelPurchase = require("../../imports/AnalyticsFuelPurchase").default;
  ...
  useEffect(() => {
    ...
    if (savedData) {
      ...
      const data = {
        monthlyPurchased: parsed.monthlyPurchased || "10,00,000",
